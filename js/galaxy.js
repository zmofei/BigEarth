...
var galacticTexture0 = THREE.ImageUtils.loadTexture("img/galactic_sharp.png");
var galacticTexture1 = THREE.ImageUtils.loadTexture("img/galactic_blur.png");
...
var galacticUniforms = {
    ...
    texture0: {
        type: "t",
        value: galacticTexture0
    },
    texture1: {
        type: "t",
        value: galacticTexture1
    },
    idealDepth: {
        type: "f",
        value: 1.0
...
function generateGalaxy() {
    ...
    var galacticShaderMaterial = new THREE.ShaderMaterial({
        ...
        vertexShader: document.getElementById('galacticstars').innerHTML,
        fragmentShader: document.getElementById('galacticstarsfsh').innerHTML,
